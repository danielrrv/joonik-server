...
app.get('/callback', async (req, res) => {
    ...
    try {
        ...
        /**
         * @function cookie.parse @input {string} cookie @returns {object}
         * 
        */
...
const redirection = function (req, res, next) {
    console.log("req.cookies", req.cookies)//undefined
    console.log("req.headers.cookie", req.headers.cookie)//exist
    console.log('type of req.headers.cookie', typeof req.headers.cookie)//string
    console.log('req.cookies', typeof req.cookies);//undefined
    // const ft =  "state" in req.cookies ? cookie.parse(req.headers.cookie).state : null;
