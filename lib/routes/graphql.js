...
router.post('/', async (req, res, next) => {
    const shop = SHOPIFY_APP_URL;//change by a query shop as req.query.shop
    const shopAccessToken = req.get('x-shopify-access-token') ? req.get('x-shopify-access-token') : req.cookies._vl
