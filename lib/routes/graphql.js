...
router.post('/', async (req, res, next) => {
    ...
    const shopAccessToken = req.get('x-shopify-access-token');
...
// curl -X POST \
//   https://joonikshop.myshopify.com/admin/api/2020-01/graphql.json \
//   -H 'Content-Type: application/json' \
//   -H 'X-Shopify-Access-Token:  942188593e42b6966146324309fa0730 ' \
//   -d ' {
